    ...
    <main class="max-w-[640px] mx-auto min-h-screen flex flex-col relative has-[#Bottom-nav]:pb-[144px]">
        ...
        <section id="Thumbnail" class="flex relative h-[370px] pt-[94px] pb-[66px] bg-[#F6F6F6]">
            ...
            <div class="flex gap-4 absolute -bottom-[35px] w-full items-center justify-center">
                <button class="thumbnail-button size-[70px] flex p-[15px_20px] rounded-full overflow-hidden bg-white flex-shrink-0 th-active">
                    ...
                    <div class="pb-4">
                        <div class="flex gap-3">
                            ...
                            <div class="flex flex-col gap-[6px] w-full">
                                ...
                                <p class="text-xs leading-5 text-[#6E6E70]">
                                    Bagus produknya dan cepet banget dipakenya
                                    anti ribet karena beberap app sudah ready
                                </p>
                            </div>
                        </div>
                    </div>
