        ...
        <form action="{{ route('front.booking_save', $product->slug) }}" method="POST" class="flex flex-col gap-[30px] mt-[30px]">
            ...
            <div class="flex items-center justify-between px-5">
                ...
                <div class="flex items-center gap-3 relative">
                    ...
                    <input type="number" name="days" id="Days" value="1" class="absolute -z-10 opacity-0 w-1" required />
                ...
                <div id="Menus" class="flex flex-col gap-4">
                    <div class="tab-link-btns flex items-center gap-4">
                        <label
                            ...
                            <input type="radio" name="delivery-type" id="Pickup" class="absolute -z-10 top-1/2 left-1/2 opacity-0"
                                onchange="toggleRequiredOptions()" required />
                        </label>
                        <label
                            class="tablink relative w-full rounded-2xl p-[18px_14px] border border-[#EDEEF0] font-semibold text-sm leading-[21px] transition-all duration-300 hover:ring-2 hover:ring-[#FCCF2F]"
                            ...
                            <input type="radio" name="delivery-type" id="Delivery" class="absolute -z-10 top-1/2 left-1/2 opacity-0"
                                onchange="toggleRequiredOptions()" required />
                        </label>
                    </div>
            ...
            <div id="Bottom-nav" class="fixed bottom-0 max-w-[640px] w-full mx-auto border-t border-[#F1F1F1] overflow-hidden z-10">
                ...
                <div class="flex items-center justify-between p-5 relative z-10">
                    ...
                    <button type="submit" class="rounded-full p-[12px_24px] bg-[#FCCF2F] font-bold w-fit">Checkout</button>
                </div>
            </div>
        </form>
    </main>
