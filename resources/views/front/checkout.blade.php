...
@section('content')
    <main class="max-w-[640px] mx-auto min-h-screen flex flex-col relative has-[#Bottom-nav]:pb-[144px]">
        ...
        <form action="{{ route('front.checkout.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-[30px] mt-[30px]">
            @csrf
            ...
            <div id="Payment-details" class="flex flex-col px-5 gap-3">
                ...
                <div class="flex flex-col gap-4">
                    <div class="flex items-center justify-between">
                        <p>Sub total</p>
                        <p class="font-semibold">Rp {{ Number::format($subTotal, locale: 'id') }}</p>
                    </div>
                    <div class="flex items-center justify-between">
                        <p>PPN 11%</p>
                        <p class="font-semibold">Rp {{ Number::format($totalPpn, locale: 'id') }}</p>
                    </div>
                    <div class="flex items-center justify-between">
                        <p>Insurance</p>
                        <p class="font-semibold">Rp {{ Number::format($insurance, locale: 'id') }}</p>
                    </div>
                    <div class="flex items-center justify-between">
                        <p>Grand total</p>
                        <p class="font-bold text-xl leading-[30px] underline">Rp {{ Number::format($grandTotal, locale: 'id') }}</p>
                    </div>
                </div>
            </div>
            <hr class="border-[#EDEEF0] mx-5">
            <div id="Send-Payment" class="flex flex-col px-5 gap-3">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col gap-[2px]">
                        <div class="flex items-center w-fit gap-1">
                            <p class="font-semibold">Official Sewa Barang</p>
